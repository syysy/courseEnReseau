...
type Game struct {
	...
	channel_lecture  chan int      // Prout
	channel_ecriture chan int
	channel_temp     chan int
	channel_string   chan string
	channel_pos		 chan float64
	nbJoueurs        int // Nombres de joueurs connectés
	myNum            int // Numéro du joueur ici de la game
}
